...
| 0.2.2 | Menu benchmark | B1 from [06-benchmark.md](06-benchmark.md): frozen maw and donors, the golden set, the deterministic menu benchmark and its CI gate | `recall_must@30` measured on master and gating pull requests |
